...
BlackGPIO pin0(GPIO_4,output);
BlackGPIO pin1(GPIO_15,output);
BlackGPIO pin2(GPIO_60,output);
BlackGPIO pin3(GPIO_5,output);
BlackGPIO pin4(GPIO_48,output);
BlackGPIO pin5(GPIO_30,output);
BlackGPIO pin6(GPIO_31,output);
// BlackGPIO pin7(GPIO_,output);
ADC adc_t1(AIN0);
ADC adc_t2(AIN1);
